...
I improved the Contact form by adding labels and five different controls: text, email, select, textarea and radio. I also added HTML5 validation using attributes such as required, minlength and pattern.
